...
public class SmoothFollow : MonoBehaviour 
{
	...
	void TrackPlayer()
	{
        ...
        if (bossCameraActive)
        {
            transform.position = new Vector3(Mathf.Lerp(transform.position.x, bossCameraTarget.position.x, 1f / cameraSpeed),
                                Mathf.Lerp(transform.position.y, bossCameraTarget.position.y, 1f / cameraSpeed),
                                Mathf.Lerp(transform.position.z, bossCameraTarget.position.z, 1f / cameraSpeed));
        }
